      ...
      <>
        <div className="text-[0.5rem] mb-20 text-center leading-tight md:text-4xl md:leading-snug bg-gradient-to-r from-green-600 via-yellow-600 to-red-600 inline-block text-transparent bg-clip-text">
          <span>Hi Tú, 
            ...
            <br /><br />
            Mà thôi mình cứ nhìn về phía trước ha. Lộc mong rằng Tú sẽ không còn sợ yêu nữa, hãy mạnh mẽ lên, dũng cảm lên nha! Tú xứng đáng với những điều tốt đẹp mà, đừng lo sợ nha. Nếu có thể, Lộc mong rằng sẽ được cầm tay Tú để cùng nhau vượt qua nỗi sợ này ^^.
            <br /><br />
